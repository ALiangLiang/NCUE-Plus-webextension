...
//indices of black
const ATLAS = [[23, 27, 31, 35, 71, 75, 79, 83, 87, 91, 119, 123, 143, 147, 171, 199, 223, 255, 271, 303, 307, 323, 355, 359, 375, 411, 427, 463, 483, 511, 515, 535, 563, 587, 591, 611, 615, 639, 643, 647, 651, 655, 659, 663, 699, 703, 707, 711],
...
(function () {
	var target = document.getElementById("imgCode");
	var atlases = [];
	for (var i = 0; i < 9; i++) {
